...
I proceeded with using an influence plot which graphs the studentized residuals against hat values ---- fitted values made by my logistic model. 
...
INFLUENCE PLOT
I used influence plot is useful in identifying unusual observations because it plots studentized residuals against hat-values, and the size of circle is proportional to Cook’s distance.
– Points with large studentized residuals, hat-values or Cook’s distances are labeled. – Nine points may be identified at maximum.
• Studentized residuals are plotted against hat-values, and the size of the circle is proportional to Cook’s distance.
– Observation ‘13.1’ shows that largest Cook’s distance, but it is moderate in hat-values.
