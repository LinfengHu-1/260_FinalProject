...
pred.tree.rose <- as.integer(pred.tree.rose>0.16)

confusionMatrix(as.factor(pred.tree.rose), as.factor(test_set$depressed))
...
fit_rf <- randomForest(depressed~., data=train_set)
